                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    @endif
                                        <h4 class="card-title mb-4">Tambah Data Team Perusahaan</h4>
                                        <form action="{{ route('team.store') }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                        <div class="row mb-4">
                                                <label for="projectname" class="col-form-label col-lg-2">Nama Team</label>
                                                <div class="col-lg-10">
                                                    <input name="nama" id="projectname" type="text" class="form-control" placeholder="Masukan Nama">
                                                </div>
                                        </div>
                                        <div class="row mb-4">
                                                <label for="projectname" class="col-form-label col-lg-2">Posisi</label>
                                                <div class="col-lg-10">
                                                    <input name="posisi" id="projectname" type="text" class="form-control" placeholder="Masukan Posisi">
                                                </div>
                                        </div>
                                        <div class="row mb-4">
