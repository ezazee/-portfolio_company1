                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0 font-size-18">Blog PT Multi Kara Digital</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                    ...
                    <table class="table align-middle table-nowrap mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="width: 100px;"><img src="/images/{{ $blog->gambar }}" alt="" class="avatar-md h-auto d-block rounded"></td>
                                <td>
