                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('blog.update', $blog->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-10">
                                <input id="title" value="{{ $blog->title }}" name="title" type="text" class="form-control" placeholder="Nama judul..." >
                            </div>
                        </div>
                        <div class="row mb-4">
                            <label for="description" class="col-form-label col-lg-2">Deskripsi</label>
                            <div class="col-lg-10">
                                <textarea id="editor" name="deskripsi" type="text">{{ $blog->deskripsi }}</textarea>
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <img class="rounded me-2" id="gambar-view" alt="200x200" src="/images/{{ $blog->gambar }}" data-holder-rendered="true" width="200">
                            </div>
                        </div>
